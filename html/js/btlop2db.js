...
function init()
{
	...
	read_file( "db/btlop2_MS.csv?v=038936f0da30bc7f6e8b95db312866ef5b29fab4", recv_ms );
	read_file( "db/btlop2_Weapon1.csv?v=66d4b70358a670340b2907162b50c29f628733df", recv_weapon1 );
	read_file( "db/btlop2_Weapon2.csv?v=e005992373add121d735e504a7729eefddb84d6b", recv_weapon2 );
	read_file( "db/btlop2_SubWeapon.csv?v=5229e62ac99da84d93e0224d65be9765bc5fd012", recv_subweapon );
